...
public class Insertar extends JFrame {
	...
	public Insertar() {
		...
		JLabel lblNewLabel = new JLabel("MENU LIBRO");
		...
		JLabel lblNewLabel_1_1_3 = new JLabel("EXISTENCIAS");
		...
		btnSQL.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String pass = textexistencias.getText();
				
				u1 = new Usuario(id, nombre, autor, ISBN, pass);
				try {
					daoSQL.create(u1);
		...
		btnTXT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int id = Integer.parseInt(textid.getText());
				String nombre  = textNom.getText();
				String apellido = textAU.getText();
				String ISBN = textISBN.getText();
				String passString = textCon.getText();
