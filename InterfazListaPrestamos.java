...
public class InterfazListaPrestamos extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	InterfazListaPrestamos frame = new InterfazListaPrestamos();
   ...
   //create the interface and pass the exceptions to it
    public InterfazListaPrestamos() throws SQLException {
    ...
    public void CargarPrestamos() throws SQLException {
        try {
            ...
            PrestamoDAOMySQL dao = new PrestamoDAOMySQL();
