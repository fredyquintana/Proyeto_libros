...
public class InterfazListaTXTB extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	InterfazListaTXTB frame = new InterfazListaTXTB();
    ...
    public InterfazListaTXTB() throws SQLException {
    ...
    public void CargarUsuariosB() throws SQLException {
        // Get the records but now in ArrayList
        UsuarioBibliotecaDAOArchivo dao = new UsuarioBibliotecaDAOArchivo("Registros.txt");
